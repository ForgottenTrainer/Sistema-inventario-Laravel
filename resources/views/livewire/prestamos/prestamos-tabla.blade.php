        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        Plomo, guantes, cascos
                    </td>
                    <td class="px-6 py-4">
                        <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">En progreso</span>
                    </td>
                    <td class="px-6 py-4">
                        24/06/2023
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <a href="#" class="font-medium text-amber-600 dark:text-amber-500 hover:underline mr-1">Contrato</a>
                        <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-1">Editar</a>
                        <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline">Ver mas</a>
                    </td>
                </tr>
            </tbody>
        </table>
